...
function skillcrushstarter_setup() {
	...
	// Post thumbnails support -- image that is chosen as the representative image for posts
...
// Defines custom markup for post comments so that I can edit them to match the design
